...
public class ConsolaOlimpicos
{
	...
	{
		System.out.print("Estadísticas sobre los Juegos Olímpicos\n\n");
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar atleta por nombre\n");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra al usuario el país de el alteta con el nombre especificado
	 */
	private void ejecutarBuscarAtletaPorNombre() {
		System.out.print("\nPais del atleta\n");
		String nombre = input("Por favor ingrese el nombre del atleta a buscar");
		Atleta atl = calculadora.buscarAtletaPorNombre(nombre);
		if (atl == null) {
			System.out.print("El atleta no se encuentra entre los datos. \n");
			return;
		}
		else {
			System.out.print("El atleta " + atl.darNombre() + " representó a " + atl.darPais().darNombre() + "\n");
		}
	...
	private void ejecutarCargarAtletas()
	{
		...
		String archivo = input("Por favor ingrese el nombre del archivo CSV con los atletas (dentro de la carpeta \"data\")");
		try
		{
